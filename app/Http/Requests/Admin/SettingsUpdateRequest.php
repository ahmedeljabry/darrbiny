...
class SettingsUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'tap_secret_key' => ['nullable', 'string', 'max:1000'],
            'tap_webhook_secret' => ['nullable', 'string', 'max:1000'],
            'tabby_public_key' => ['nullable', 'string', 'max:500'],
            'tabby_secret_key' => ['nullable', 'string', 'max:1000'],
            'tabby_webhook_secret' => ['nullable', 'string', 'max:1000'],
            'tabby_merchant_code' => ['nullable', 'string', 'max:255'],
            'tabby_base_url' => ['nullable', 'url', 'max:500'],
            'tabby_enabled' => ['nullable', 'boolean'],
            'tamara_public_key' => ['nullable', 'string', 'max:500'],
            'tamara_secret_key' => ['nullable', 'string', 'max:1000'],
            'tamara_webhook_secret' => ['nullable', 'string', 'max:1000'],
            'tamara_base_url' => ['nullable', 'url', 'max:500'],
            ...
            'sms_base_url' => ['nullable', 'url', 'max:500'],
