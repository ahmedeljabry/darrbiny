...
Route::prefix('v1')->middleware(['correlation', 'json.envelope', 'sanitize'])->group(function () {
    ...
    Route::prefix('home')->group(function () {
        ...
        Route::delete('favorites/{trainerId}', [\App\Modules\Favorites\Http\Controllers\FavoriteController::class, 'destroy'])->middleware('auth:sanctum');
    });
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/notifications/devices', [\App\Modules\Notifications\Http\Controllers\NotificationDeviceController::class, 'store']);
        Route::delete('/notifications/devices', [\App\Modules\Notifications\Http\Controllers\NotificationDeviceController::class, 'destroy']);
