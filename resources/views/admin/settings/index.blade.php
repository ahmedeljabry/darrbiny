                          ...
                          <div class="card-body">
                            ...
                            <div class="alert alert-info">
                              <div class="d-flex align-items-start gap-2">
                                <i class="icon-base ti tabler-info-circle mt-1"></i>
                                <div>
                                  <strong>مهم:</strong> صفحات الحجوزات والمدفوعات وتقارير المبيعات والمدفوعات والاشتراكات وضريبة القيمة المضافة تعرض المبالغ بالـ {{ $reportCurrency }} بعد التحويل حسب السعر المحفوظ لكل عملة.
