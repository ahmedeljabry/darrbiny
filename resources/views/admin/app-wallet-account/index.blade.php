  ...
  <div class="card report-panel">
    <div class="card-body">
      ...
      <div class="report-note-box mb-4">
        <p>الوارد يشمل رسوم الحجز الثابتة ورسوم الحجز على الباقات والدفع الكلي بالكامل، مع بقاء فلتر مستقل لتحليل رسوم التطبيق فقط عند الحاجة. أما الصادر فيعكس كل مصروفات التطبيق المسجلة. بطاقات الملخص والتقسيمات أدناه محولة إلى {{ $reportCurrency }}، بينما يعرض الجدول العملة الأصلية لكل حركة.</p>
      </div>
