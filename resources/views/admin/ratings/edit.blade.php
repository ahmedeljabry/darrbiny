...
<div class="card">
  <div class="card-header d-flex align-items-center gap-2">
    ...
    <div>
      ...
      <small class="text-body-secondary">تعديل تفاصيل التقييم</small>
    </div>
  </div>
  <div class="card-body">
    <form method="post" action="{{ route('admin.ratings.update', $rating) }}">
      ...
      <div class="row g-3 mt-0">
        <div class="col-md-6">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="number" name="stars" class="form-control" min="1" max="5" value="{{ old('stars', $rating->stars) }}" required>
          </div>
      ...
      <div class="mb-3 mt-3">
        ...
        <div class="input-group input-group-merge">
          ...
          <textarea name="comment" class="form-control" rows="4" placeholder="اكتب تعليق التقييم (اختياري)">{{ old('comment', $rating->comment) }}</textarea>
        </div>
      ...
      <div class="d-flex justify-content-end gap-2 mt-4">
        ...
        <button type="submit" class="btn btn-primary">
          <i class="icon-base ti tabler-device-floppy me-1"></i> حفظ التغييرات
        </button>
      </div>
    </form>
  </div>
