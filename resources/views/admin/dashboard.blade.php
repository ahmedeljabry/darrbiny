...
@php
  ...
  $financeCards = [
    ...
    ['label' => 'المصروفات', 'value' => number_format($expensesMinor / 100, 2) . ' ' . $reportCurrency, 'desc' => 'المصروفات المسجلة + رسوم بوابات الدفع ضمن النطاق', 'icon' => 'credit-card-off', 'tone' => 'danger'],
